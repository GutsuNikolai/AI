...
W, H = P.win_w, P.win_h
zones = [
    (int(W * 0.35), int(H * 0), 80, 80),  # слева - вверху
    (int(W * 0.5), int(H * 0.5), 80, 80),  # центр между колонами
    (int(W * 0.65), int(H * 0.85), 80, 80),  # справа-снизу  (у правой колонны)
    (int(W * 0), int(H * 0.85), 80, 80),    # слева - внизу
]
